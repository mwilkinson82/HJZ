...
const Guides = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="pt-32 pb-16 bg-gradient-to-br from-navy/5 via-white to-coral/5">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="font-playfair text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-navy mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button 
                ...
                variant="outline"
                className="border-navy text-navy hover:bg-navy hover:text-white px-6 sm:px-8 py-3 rounded-full"
              >
      ...
      {/* ADU Guide */}
      <section id="adu-guide" className="py-16 sm:py-20 bg-white">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-4xl mx-auto">
            <h2 className="font-playfair text-3xl sm:text-4xl font-bold text-navy mb-8 text-center">
              What You Must Know Before Starting an ADU or Addition in Massachusetts
            </h2>
            
            <div className="space-y-8 sm:space-y-12">
              {/* Section 1 */}
              <div className="bg-gradient-to-r from-coral/5 to-navy/5 p-6 sm:p-8 rounded-xl">
              ...
              {/* Section 2 */}
              <div className="bg-white border border-coral/20 p-6 sm:p-8 rounded-xl shadow-lg">
                <h3 className="font-playfair text-xl sm:text-2xl font-bold text-navy mb-4">
                  2. Is an ADU or Addition Right for You?
                </h3>
                <p className="text-gray-700 mb-4 text-sm sm:text-base">Ask yourself:</p>
                <ul className="space-y-2 text-gray-700 text-sm sm:text-base">
                  <li className="flex items-start">
                    <CheckCircle className="h-4 w-4 sm:h-5 sm:w-5 text-coral mt-0.5 mr-3 flex-shrink-0" />
              ...
              {/* Section 3 */}
              <div className="bg-gradient-to-r from-navy/5 to-coral/5 p-6 sm:p-8 rounded-xl">
                <h3 className="font-playfair text-xl sm:text-2xl font-bold text-navy mb-4">
                ...
                <div className="space-y-6">
                  <div className="space-y-3">
                    <div className="flex items-start">
                      <span className="bg-coral text-white rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mr-3 mt-0.5 flex-shrink-0">1</span>
                      <span className="text-gray-700 text-sm sm:text-base">Research zoning and verify local ADU regulations</span>
                    </div>
                    <div className="flex items-start">
                      <span className="bg-coral text-white rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mr-3 mt-0.5 flex-shrink-0">2</span>
                      <span className="text-gray-700 text-sm sm:text-base">Get a site evaluation and feasibility review</span>
                    </div>
                    <div className="flex items-start">
                      <span className="bg-coral text-white rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mr-3 mt-0.5 flex-shrink-0">3</span>
                      <span className="text-gray-700 text-sm sm:text-base">Work with a design/build team for plans and estimates</span>
                    </div>
                    <div className="flex items-start">
                      <span className="bg-coral text-white rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mr-3 mt-0.5 flex-shrink-0">4</span>
                      <span className="text-gray-700 text-sm sm:text-base">Submit permits to your local building department</span>
                    </div>
                    <div className="flex items-start">
                      <span className="bg-coral text-white rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mr-3 mt-0.5 flex-shrink-0">5</span>
                      <span className="text-gray-700 text-sm sm:text-base">Build the unit and pass inspections</span>
                    </div>
                    <div className="flex items-start">
                      <span className="bg-coral text-white rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mr-3 mt-0.5 flex-shrink-0">6</span>
                      <span className="text-gray-700 text-sm sm:text-base">Occupy or rent the space as allowed</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* Section 4 */}
              <div className="bg-white border border-navy/20 p-6 sm:p-8 rounded-xl shadow-lg">
                <h3 className="font-playfair text-xl sm:text-2xl font-bold text-navy mb-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
                <div className="bg-white border border-coral/20 p-4 sm:p-6 rounded-xl shadow-lg">
                  <h3 className="font-playfair text-lg sm:text-xl font-bold text-navy mb-4">
                ...
                <div className="bg-white border border-navy/20 p-4 sm:p-6 rounded-xl shadow-lg">
                  <h3 className="font-playfair text-lg sm:text-xl font-bold text-navy mb-4">
                    7. Before You Build Checklist
                  </h3>
                  <ul className="space-y-2 text-gray-700 text-xs sm:text-sm">
                    <li className="flex items-start">
                      <CheckCircle className="h-3 w-3 sm:h-4 sm:w-4 text-coral mt-0.5 mr-2 flex-shrink-0" />
              ...
              {/* CTA */}
              <div className="bg-gradient-to-r from-coral to-coral-600 text-white p-6 sm:p-8 rounded-xl text-center">
      ...
      <section id="preconstruction-guide" className="py-16 sm:py-20 bg-gradient-to-br from-navy/5 via-white to-coral/5">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-4xl mx-auto">
            <h2 className="font-playfair text-3xl sm:text-4xl font-bold text-navy mb-8 text-center">
            ...
            <div className="bg-white p-6 sm:p-8 rounded-xl shadow-lg mb-8 sm:mb-12">
              <h3 className="font-playfair text-xl sm:text-2xl font-bold text-navy mb-4">Introduction</h3>
            ...
            <div className="space-y-8 sm:space-y-12">
              {/* Reason 1 */}
              <div className="bg-white border-l-4 border-coral p-6 sm:p-8 rounded-r-xl shadow-lg">
                <h3 className="font-playfair text-xl sm:text-2xl font-bold text-navy mb-4">
                ...
                <div className="bg-coral/10 p-4 rounded-lg">
                  <h4 className="font-semibold text-navy mb-2 text-sm sm:text-base">Benefits:</h4>
              ...
              {/* Reason 2 */}
              <div className="bg-white border-l-4 border-navy p-6 sm:p-8 rounded-r-xl shadow-lg">
                <h3 className="font-playfair text-xl sm:text-2xl font-bold text-navy mb-4">
              ...
              {/* Conclusion */}
              <div className="bg-gradient-to-r from-navy to-navy-600 text-white p-6 sm:p-8 rounded-xl">
                <h3 className="font-playfair text-xl sm:text-2xl font-bold mb-4">Conclusion</h3>
                ...
                <div className="text-center">
                  <h4 className="font-semibold text-lg sm:text-xl mb-4">Need Help Getting Started?</h4>
                  <p className="mb-6 text-sm sm:text-base">
