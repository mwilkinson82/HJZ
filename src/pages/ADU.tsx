          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            <div className="group overflow-hidden rounded-xl shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105 section-animate" style={{animationDelay: '0.1s'}}>
              ...
              <div className="p-4 sm:p-6 bg-white">
                <h3 className="font-playfair text-lg sm:text-xl font-bold text-navy mb-2">Modern Detached ADU</h3>
                <p className="text-sm sm:text-base text-gray-600">Contemporary design with elevated living space and integrated garage</p>
              </div>
            </div>
            ...
            <div className="group overflow-hidden rounded-xl shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105 section-animate" style={{animationDelay: '0.2s'}}>
              ...
              />
              <div className="p-4 sm:p-6 bg-white">
                <h3 className="font-playfair text-lg sm:text-xl font-bold text-navy mb-2">Multi-Level ADU</h3>
                <p className="text-sm sm:text-base text-gray-600">Natural materials blend seamlessly with modern architectural elements</p>
              </div>
            </div>
            ...
            <div className="group overflow-hidden rounded-xl shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105 section-animate md:col-span-2 lg:col-span-1" style={{animationDelay: '0.3s'}}>
              ...
              />
              <div className="p-4 sm:p-6 bg-white">
                <h3 className="font-playfair text-lg sm:text-xl font-bold text-navy mb-2">Compact Efficient ADU</h3>
                <p className="text-sm sm:text-base text-gray-600">Maximizing space efficiency with thoughtful design and outdoor integration</p>
              </div>
            </div>
          </div>
        </div>
