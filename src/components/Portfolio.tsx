      ...
      {selectedImage && selectedImage !== "modal" && (
        ...
        >
          <div className="relative max-w-[95vw] max-h-[95vh] w-full">
            ...
            <button 
              onClick={closeModal}
              className="absolute top-2 sm:top-4 right-2 sm:right-4 text-white bg-black/50 rounded-full p-2 hover:bg-black/70 transition-colors text-lg sm:text-xl z-10"
            >
              ✕
            </button>
          </div>
